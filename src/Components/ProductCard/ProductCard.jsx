    ...
    <div>
      <div className="card w-96 bg-base-100 shadow-sm relative">
        <div className="card-body">
          ...
          <br />
          <div>
            <span className="text-4xl border border-[#eae6e6] p-2 rounded-full">{icon}</span>
          </div>
          <div className="space-y-5 mt-8">
         
                <h2 className="text-3xl font-bold">{name}</h2>
                <p className="text-[#627382] text-lg">{description}</p>
                <h3><span className="text-3xl font-bold">${price} </span><span className="text-xl text-[#627382]">/{period}</span> </h3>
          </div>
