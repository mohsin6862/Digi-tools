...
const Banner = () => {
  return (
    <div className="my-20 flex gap-16 items-center justify-around">
      <div className="banner-info space-y-5">
        <div className="bg-[#E1E7FF] p-2 rounded-4xl max-w-74 flex gap-2 items-center">
            <img className="h-2 w-2" src={circleImg} alt="" />
        <p className="text-[rgba(85,54,246,1)] font-medium"> New: AI-Powered Tools Available</p>
        </div>
        <h1 className="text-[#101727] font-extrabold text-7xl leading-22">
          Supercharge Your <br /> Digital Workflow
        </h1>
        <p className="font-light text-[#627382} max-w-2xl">
